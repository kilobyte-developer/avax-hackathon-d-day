// src/components/InsuranceProducts.jsx
import React, { useState } from "react";
import { motion, AnimatePresence } from "framer-motion";
import { Check, Plane, Briefcase, Heart, ArrowRight, X, Calendar, MapPin, Shield, Zap, Clock, Users, Wallet } from "lucide-react";
...
const InsuranceProducts = () => {
  ...
  const products = {
    ...
    baggage: {
      ...
      parametric: true,
      oracle: "Airline API Integration",
      payoutTime: "< 24 hours"
    },
    medical: {
    ...
    cancellation: {
      ...
      features: ["Unexpected illness", "Family emergency", "Severe weather", "Job loss"],
      coverage: "$1,000-5,000",
      premium: "$20-50 per trip",
      details: "Protection against unforeseen circumstances that force trip cancellation",
      parametric: false,
      oracle: "Document Verification",
      payoutTime: "< 72 hours"
    }
  };
      ...
      <div className="container mx-auto">
        ...
        >
          ...
          <p className={`text-xl max-w-3xl mx-auto ${
            ...
            Flexible, parametric insurance products designed for the modern traveler with instant payouts
          </p>
        </motion.div>
        ...
        >
          {[
            { value: "12,489+", label: "Active Policies", icon: <Shield className="w-8 h-8" /> },
            { value: "60s", label: "Avg. Payout Time", icon: <Clock className="w-8 h-8" /> },
            { value: "150+", label: "Countries Covered", icon: <MapPin className="w-8 h-8" /> },
            { value: "98%", label: "Customer Satisfaction", icon: <Users className="w-8 h-8" /> }
          ].map((stat, index) => (
            <motion.div
              key={index}
        ...
        >
          ...
          <div className="absolute bottom-8 left-8 right-8">
            ...
            <h3 className={`text-3xl font-semibold mb-4 ${
              isDarkTheme ? 'text-white' : 'text-slate-800'
            }`}>Automated Protection</h3>
            <p className={isDarkTheme ? 'text-blue-200' : 'text-blue-600'}>
              Our smart contracts automatically trigger payouts based on predefined conditions using oracle data—no paperwork or waiting.
            </p>
          </div>
        </motion.div>
        ...
        >
          <h3 className={`text-3xl font-semibold mb-12 text-center ${
            isDarkTheme ? 'text-white' : 'text-slate-800'
          }`}>How Our Parametric Insurance Works</h3>
            ...
            {[
              {
                ...
                description: "Select your coverage and pay with crypto or stablecoins",
                icon: <Wallet className="w-8 h-8" />
              },
              {
                step: "2",
                title: "Event Detection",
                description: "Oracles monitor real-world data for qualifying events",
                icon: <Shield className="w-8 h-8" />
              },
              {
                step: "3",
                title: "Automatic Payout",
                description: "Smart contracts trigger instant payouts to your wallet",
                ...
                <div className="grid md:grid-cols-2 gap-6 mb-6">
                  <div className={`rounded-xl p-4 ${
                    ...
                    <div className={`font-semibold text-xl ${
                      ...
                      {products[selectedProduct].coverage}
                    </div>
                  </div>
                  <div className={`rounded-xl p-4 ${
                    isDarkTheme ? 'bg-blue-900/50' : 'bg-blue-50'
                    ...
                    <div className={`font-semibold text-xl ${
                      ...
                      {products[selectedProduct].premium}
                    </div>
                  </div>
                  <div className={`rounded-xl p-4 ${
                    isDarkTheme ? 'bg-blue-900/50' : 'bg-blue-50'
                    ...
                    <div className={`font-semibold text-xl ${
                      ...
                      {products[selectedProduct].payoutTime}
                    </div>
                  </div>
                  <div className={`rounded-xl p-4 ${
                    isDarkTheme ? 'bg-blue-900/50' : 'bg-blue-50'
                    ...
                    <div className={`font-semibold text-xl ${
                      ...
                      {products[selectedProduct].oracle}
                    </div>
                  </div>
                </div>
                <div className="space-y-3 mb-6">
